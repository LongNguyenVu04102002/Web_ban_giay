...
<div class="content">
    <div class="container">
        ...
        <form:form action="/mau-sac/add" method="post" modelAttribute="mauSac">
            <form:input path="mauSacId" cssStyle="display: none"></form:input>
            ...
            <button type="submit" formaction="/mau-sac/update/${id}" class="btn btn-warning">Update</button>
        ...
        <table class="table">
            ...
            <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info"><a href="/mau-sac/detail/${x.mauSacId}"
                                                        style="text-decoration: none; color: white">Chi tiết</a>
                        </button>
                        <button class="btn btn-danger"><a href="/mau-sac/remove/${x.mauSacId}"
