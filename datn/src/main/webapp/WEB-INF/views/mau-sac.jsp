                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                        <tr>
                            ...
                            <td>
                                <a href="/mau-sac/detail/${x.mauSacId}"
                                   style="text-decoration: none; color: white">
                                    <button class="btn btn-info"><i
                                            class="bi bi-search"></i>
                                    </button>
                                </a>
                                <a href="/mau-sac/remove/${x.mauSacId}"
            ...
            <div class="col-md-4">
                <div class="form-card">
                    <form:form action="/mau-sac/add" method="post" modelAttribute="mauSac">
                        ...
                        <button type="submit" formaction="/mau-sac/update/${id}" class="btn btn-warning" onclick="return confirmAction('Bạn có chắc chắn muốn sửa?')"><i
