...
<div class="content">
    <div class="container">
        <h1 style="text-align: center">Kích thước</h1>
        <form:form action="/kich-thuoc/add" method="post" modelAttribute="kichThuoc">
            ...
            <button type="submit" formaction="/kich-thuoc/update/${id}" class="btn btn-warning">Update</button>
        ...
        <table class="table">
            ...
            <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info"><a href="/kich-thuoc/detail/${x.kichThuocId}"
                                                        style="text-decoration: none; color: white">Chi tiết</a>
                        </button>
                        <button class="btn btn-danger"><a href="/kich-thuoc/remove/${x.kichThuocId}"
