                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                        <tr>
                            ...
                            <td>
                                <a href="/kich-thuoc/detail/${x.kichThuocId}"
                                   style="text-decoration: none; color: white">
                                    <button class="btn btn-info"><i
                                            class="bi bi-search"></i>
                                    </button>
                                </a>
                                <a href="/kich-thuoc/remove/${x.kichThuocId}"
                                   style="text-decoration: none; color: white"
                                   onclick="return confirmAction('Bạn có chắc chắn muốn xóa?')">
            ...
            <div class="col-md-4">
                <div class="form-card">
                    <form:form action="/kich-thuoc/add" method="post" modelAttribute="kichThuoc">
                        <form:input path="kichThuocId" cssStyle="display: none"></form:input>

                        <div class="mb-3">
                            <label class="form-label">Kích cỡ</label>
                            <form:input path="ten" cssClass="form-control" oninput="this.value = this.value.replace(/[^0-9]/g, '')"></form:input>
                        ...
                        <form:button type="submit" class="btn btn-success"
                                     onclick="return confirmAction('Bạn có chắc chắn muốn thêm mới?')"><i
                                class="bi bi-plus-circle"></i></form:button>
                        <button type="submit" formaction="/kich-thuoc/update/${id}" class="btn btn-warning"
                                onclick="return confirmAction('Bạn có chắc chắn muốn sửa?')"><i
