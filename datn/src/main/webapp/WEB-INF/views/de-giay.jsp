...
<div class="content">
    <div class="container">
        <h1 style="text-align: center">Đế giày</h1>
        <form:form action="/de-giay/add" method="post" modelAttribute="deGiay">
            ...
            <button type="submit" formaction="/de-giay/update/${id}" class="btn btn-warning">Update</button>
        ...
        <table class="table">
            ...
            <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info"><a href="/de-giay/detail/${x.deGiayId}"
                                                        style="text-decoration: none; color: white">Chi tiết</a>
                        </button>
                        <button class="btn btn-danger"><a href="/de-giay/remove/${x.deGiayId}"
