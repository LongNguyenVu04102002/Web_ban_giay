    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="form-container">
                ...
                <form:form action="${pageContext.request.contextPath}/updateKhachHang/${khachHang.khachHangId}" modelAttribute="khachHang" method="post">
                   ...
                   <input type="hidden" name="pageSize" value="${pageSize}" />
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check form-check-inline">
                            <form:radiobutton path="gioiTinh" value="true" id="nam" cssClass="form-check-input" />
                            <label class="form-check-label" for="nam">Nam</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <form:radiobutton path="gioiTinh" value="false" id="nu" cssClass="form-check-input" />
                    ...
                    <div class="mb-3">
                        ...
                        <form:input path="sdt" id="sdt" cssClass="form-control" />
                        <form:errors path="sdt" cssClass="text-danger" />
                    </div>

                    <div class="mb-3">
                        <label for="trangThai">Trạng Thái:</label>
                        <form:select path="trangThai" id="trangThai" cssClass="form-control">
