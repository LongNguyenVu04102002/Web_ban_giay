...
<div class="content">
    <div class="container">
        ...
        <form:form action="/thuong-hieu/add" method="post" modelAttribute="thuongHieu">
            <form:input path="thuongHieuId" cssStyle="display: none"></form:input>
            ...
            <button type="submit" formaction="/thuong-hieu/update/${id}" class="btn btn-warning">Update</button>
        ...
        <table class="table">
            ...
            <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info"><a href="/thuong-hieu/detail/${x.thuongHieuId}"
                                                        style="text-decoration: none; color: white">Chi tiết</a>
                        </button>
                        <button class="btn btn-danger"><a href="/thuong-hieu/remove/${x.thuongHieuId}"
