                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                        <tr>
                            ...
                            <td>
                                <a href="/thuong-hieu/detail/${x.thuongHieuId}"
                                   style="text-decoration: none; color: white">
                                    <button class="btn btn-info"><i
                                            class="bi bi-search"></i>
                                    </button>
                                </a>
                                <a href="/thuong-hieu/remove/${x.thuongHieuId}"
            ...
            <div class="col-md-4">
                <div class="form-card">
                    <form:form action="/thuong-hieu/add" method="post" modelAttribute="thuongHieu">
                        ...
                        <button type="submit" formaction="/thuong-hieu/update/${id}" class="btn btn-warning" onclick="return confirmAction('Bạn có chắc chắn muốn sửa?')"><i
