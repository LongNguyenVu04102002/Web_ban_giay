...
<div class="content">
    <div class="container">
        <h1 style="text-align: center">Cổ giày</h1>
        <form:form action="/co-giay/add" method="post" modelAttribute="coGiay">
            <form:input path="coGiayId" cssStyle="display: none"></form:input>
            ...
            <button type="submit" formaction="/co-giay/update/${id}" class="btn btn-warning">Update</button>
        ...
        <table class="table">
            ...
            <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info"><a href="/co-giay/detail/${x.coGiayId}"
                                                        style="text-decoration: none; color: white">Chi tiết</a>
                        </button>
                        <button class="btn btn-danger"><a href="/co-giay/remove/${x.coGiayId}"
