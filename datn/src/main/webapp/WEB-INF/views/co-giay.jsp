                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                        <tr>
                            ...
                            <td>
                                <a href="/co-giay/detail/${x.coGiayId}"
                                   style="text-decoration: none; color: white">
                                    <button class="btn btn-info"><i
                                            class="bi bi-search"></i>
                                    </button>
                                </a>
                                <a href="/co-giay/remove/${x.coGiayId}"
            ...
            <div class="col-md-4">
                <div class="form-card">
                    <form:form action="/co-giay/add" method="post" modelAttribute="coGiay">
                        ...
                        <button type="submit" formaction="/co-giay/update/${id}" class="btn btn-warning" onclick="return confirmAction('Bạn có chắc chắn muốn sửa?')"><i
