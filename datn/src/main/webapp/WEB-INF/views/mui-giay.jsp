...
<div class="content">
    <div class="container">
        <h1 style="text-align: center">Mũi giày</h1>
        <form:form action="/mui-giay/add" method="post" modelAttribute="muiGiay">
            <form:input path="muiGiayId" cssStyle="display: none"></form:input>
            ...
            <button type="submit" formaction="/mui-giay/update/${id}" class="btn btn-warning">Update</button>
        ...
        <table class="table">
            ...
            <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info"><a href="/mui-giay/detail/${x.muiGiayId}"
                                                        style="text-decoration: none; color: white">Chi tiết</a>
                        </button>
                        <button class="btn btn-danger"><a href="/mui-giay/remove/${x.muiGiayId}"
