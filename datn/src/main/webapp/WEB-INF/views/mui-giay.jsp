                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                        <tr>
                            ...
                            <td>
                                <a href="/mui-giay/detail/${x.muiGiayId}"
                                   style="text-decoration: none; color: white">
                                    <button class="btn btn-info"><i
                                            class="bi bi-search"></i>
                                    </button>
                                </a>
                                <a href="/mui-giay/remove/${x.muiGiayId}"
            ...
            <div class="col-md-4">
                <div class="form-card">
                    <form:form action="/mui-giay/add" method="post" modelAttribute="muiGiay">
                        ...
                        <button type="submit" formaction="/mui-giay/update/${id}" class="btn btn-warning" onclick="return confirmAction('Bạn có chắc chắn muốn sửa?')"><i
