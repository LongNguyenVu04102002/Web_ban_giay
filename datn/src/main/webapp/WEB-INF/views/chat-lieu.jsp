...
<div class="content">
    <div class="container">
        ...
        <form:form action="/chat-lieu/add" method="post" modelAttribute="chatLieu">
            ...
            <button type="submit" formaction="/chat-lieu/update/${id}" class="btn btn-warning">Update</button>
        ...
        <table class="table">
            ...
            <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info"><a href="/chat-lieu/detail/${x.chatLieuId}"
                                                        style="text-decoration: none; color: white">Chi tiết</a>
                        </button>
                        <button class="btn btn-danger"><a href="/chat-lieu/remove/${x.chatLieuId}"
