                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                        <tr>
                            ...
                            <td>
                                <a href="/chat-lieu/detail/${x.chatLieuId}"
                                   style="text-decoration: none; color: white">
                                    <button class="btn btn-info"><i
                                            class="bi bi-search"></i>
                                    </button>
                                </a>
                                <a href="/chat-lieu/remove/${x.chatLieuId}"
                                   style="text-decoration: none; color: white"
            ...
            <div class="col-md-4">
                <div class="form-card">
                    <form:form action="/chat-lieu/add" method="post" modelAttribute="chatLieu">
                        <form:input path="chatLieuId" cssStyle="display: none"></form:input>
                        ...
                        <button type="submit" formaction="/chat-lieu/update/${id}" class="btn btn-warning"
