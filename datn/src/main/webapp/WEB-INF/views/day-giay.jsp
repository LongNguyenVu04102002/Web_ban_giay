...
<div class="content">
    <div class="container">
        <h1 style="text-align: center">Dây giày</h1>
        <form:form action="/day-giay/add" method="post" modelAttribute="dayGiay">
            <form:input path="dayGiayId" cssStyle="display: none"></form:input>
            ...
            <button type="submit" formaction="/day-giay/update/${id}" class="btn btn-warning">Update</button>
        ...
        <table class="table">
            ...
            <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info"><a href="/day-giay/detail/${x.dayGiayId}"
                                                        style="text-decoration: none; color: white">Chi tiết</a>
                        </button>
                        <button class="btn btn-danger"><a href="/day-giay/remove/${x.dayGiayId}"
