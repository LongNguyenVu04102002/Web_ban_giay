                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                        <tr>
                            ...
                            <td>
                                <a href="/day-giay/detail/${x.dayGiayId}"
                                   style="text-decoration: none; color: white">
                                    <button class="btn btn-info"><i
                                            class="bi bi-search"></i>
                                    </button>
                                </a>
                                <a href="/day-giay/remove/${x.dayGiayId}"
            ...
            <div class="col-md-4">
                <div class="form-card">
                    <form:form action="/day-giay/add" method="post" modelAttribute="dayGiay">
                        ...
                        <form:button type="submit" class="btn btn-success"><i
                                class="bi bi-plus-circle"></i></form:button>
                        <button type="submit" formaction="/day-giay/update/${id}" class="btn btn-warning"><i
