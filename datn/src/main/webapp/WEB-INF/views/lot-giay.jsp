                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${lst.content}" var="x" varStatus="vTri">
                        <tr>
                            ...
                            <td>
                                <a href="/lot-giay/detail/${x.lotGiayId}"
                                   style="text-decoration: none; color: white"><button class="btn btn-info"><i
                                        class="bi bi-search"></i>
                                </button></a>
                                <a href="/lot-giay/remove/${x.lotGiayId}"
            ...
            <div class="col-md-4">
                <div class="form-card">
                    <form:form action="/lot-giay/add" method="post" modelAttribute="lotGiay">
                        ...
                        <button type="submit" formaction="/lot-giay/update/${id}" class="btn btn-warning" onclick="return confirmAction('Bạn có chắc chắn muốn sửa?')"><i
